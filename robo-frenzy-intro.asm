...
;
;             most work originally by Davide Bucci, April-June 2018
;             additional work by Nicholas Baldridge (foramusementonlypodcast@gmail.com)
;
...
ScoreDesc:   .byte "                      "
             ...
             .byte " ", ('P'-'@'),('T'-'@'),"   ",PLAYER,(61+$80),('Y'-'@'),('O'-'@'),('U'-'@'),"   "
             .byte ('B'-'@'),('R'-'@'),('I'-'@'),('N'-'@'),('G'-'@')," ",GEAR," ",('U'-'@'),('P'-'@')," ",('T'-'@'),('O'-'@')," ",('B'-'@'),('U'-'@'),('I'-'@'),('L'-'@'),('D'-'@')
             ;.byte "                      "
             .byte "   ",('A'-'@'),('V'-'@'),('O'-'@'),('I'-'@'),('D'-'@')," ",('T'-'@'),('E'-'@'),('N'-'@'),('T'-'@'),('A'-'@'),('C'-'@'),('L'-'@'),('E'-'@')
             .byte "                      ",0
